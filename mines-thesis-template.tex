...
%	
 ...
 }         % this is the full title of your work
%\title{This is a medium medium medium medium medium medium medium title $\frac{2^{15}}{\pi}$ for testing} 

%\title{This is a short title $\frac{2^{15}}{\pi}$ for testing} 
...
% Double spacing or 1.5 spacing
% \begin{macro}{\spacing}
%
%   Redefine |\baselinestretch| to |\spacing|, 
%
%    \begin{macrocode}
\newcommand{\spacing}[1]{\setstretch{#1}}
%    \end{macrocode}
% \end{macro}
